return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>sf", "<cmd>Telescope find_files<cr>", { desc = "Fuzzy search files in cwd" })
    keymap.set("n", "<leader>sr", "<cmd>Telescope oldfiles<cr>", { desc = "Fuzzy search recent files" })
    keymap.set("n", "<leader>ss", "<cmd>Telescope live_grep<cr>", { desc = "Search string in cwd" })
